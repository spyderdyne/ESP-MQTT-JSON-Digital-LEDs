...
#### Demo/Build Videos
[![Demo Video](https://youtu.be/WNp4G49tkrQ "Demo - RGB Digital LED Strip controlled using ESP, MQTT, and Home Assistant")
...
```
<!--stackedit_data:
eyJoaXN0b3J5IjpbOTcwMTMzMDExLC0xODk3MDAxMTUxLC0xOD
